...
export default function InstitutPage() {
  ...
  const handleSearch = () => {
    if (!ville) return
    router.push(`/recherche?service=institut&ville=${encodeURIComponent(ville)}`)
  }

  const villes = [
    { name: "Alger", image: "/img/institut-alger.jpg" },
    { name: "Oran", image: "/img/institut-oran.jpg" },
    { name: "Tizi Ouzou", image: "/img/institut-tizi.jpg" },
  ]
  ...
  return (
    <div className="bg-white">
      ...
      <section className="text-center py-16 bg-gray-100">
        <h1 className="text-4xl font-bold mb-6">Réservez votre soin en Institut de Beauté</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-semibold mb-6">Instituts populaires</h2>
